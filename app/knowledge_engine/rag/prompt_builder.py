...
- Si, après avoir retiré le jargon et les détails non actionnables, il ne reste presque rien d'utile à dire sur le "pourquoi", ne force pas une explication scientifique : va directement à ce que tu peux conseiller (par exemple la surveillance) et à l'honnêteté sur ce qui manque.
...
Pour une liste courte d'actions concrètes (2-3 éléments maximum), utilise :
* élément de la liste
